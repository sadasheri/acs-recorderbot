...
//   value of incoming HTTP requests from Azure Communication Service.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Sample.RecorderBot.FrontEnd.Http
{
    ...
    internal class LoggingMessageHandler : DelegatingHandler
    {
        ...
        /// The URL Ignorers.
        /// </param>
        public LoggingMessageHandler(bool isIncomingMessageHandler, Logger logger, string[] urlIgnorers = null)
        {
