...
namespace Sample.RecorderBot.FrontEnd
{
    using System;
    ...
    public interface IConfiguration : IDisposable
    {
        ...
        /// </summary>
        IList<Uri> CallControlListeningUrls { get; }
        ...
        /// <summary>
        /// Gets the Acs application instance id.
        /// </summary>
        string ACSApplicationInstanceId { get; }

        /// <summary>
        /// Gets the Acs connestion string.
        /// </summary>
        string ACSConnectionString { get; }
